...
ggsave(filename = str_glue('figures/Figure_S8.png'), plot = wrap_plots(p1,p2, ncol = 2, guides = "collect") + plot_annotation(tag_levels = 'a'), device = "png", width = 25, height = 10, units = "cm")
ggsave(filename = str_glue('figures/Figure_S8.pdf'), plot = wrap_plots(p1,p2, ncol = 2, guides = "collect") + plot_annotation(tag_levels = 'a'), device = "pdf", width = 25, height = 10, units = "cm")
